...
export class AccountService {
  ...
  getList() {
    return this.accountEndpoint.getListEndpoint<any>();
  }

  addPromoCode(object: any) {
    return this.accountEndpoint.addPromoCodeEndpoint<any>(object);
  }

  updatePromoCode(id: string) {
    return this.accountEndpoint.updatePromoCodeEndpoint(id);
  }
